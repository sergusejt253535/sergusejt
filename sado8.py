...
st.set_page_config(page_title="SDR PRESTIGE GLOBAL | V.5.0", layout="wide")
st_autorefresh(interval=15 * 1000, key="sdr_binance_v50")
...
st.markdown(f"""
    <div class="top-bar">
        <div style='color:#00ffcc; font-weight:bold; font-size:20px;'>📡 SDR COMMERCIAL CORE V5.0</div>
...
if not df.empty:
    ...
    st.info("📡 Connecting to Binance Global via SDR Hub...")

# --- 5. LİSANS & BİLGİLENDİRME (BINANCE EKLEMELİ) ---
st.write("---")
