...
with c1:
    ...
    <div class="info-box" style="border-left: 10px solid #ff4b4b;">
        ...
        <p><b>YATIRIM DANIŞMANLIĞI DEĞİLDİR.</b> Bu paneldeki veriler Binance API üzerinden canlı gelir. Tüm risk kullanıcıya aittir.</p>
        <p><i><b>NOT INVESTMENT ADVICE.</b> Data is pulled live via Binance API. All risks belong to the user.</i></p>
    </div>
    """, unsafe_allow_html=True)
...
with c2:
    ...
    <div class="info-box" style="border-left: 10px solid #FFD700;">
        ...
        <p><b>%88+ GÜÇ:</b> Kâr Al bölgesi. <b>%15- GÜÇ:</b> Toplama bölgesi. Sistem 15 saniyede bir güncellenir.</p>
        <p><i><b>%88+ POWER:</b> Take Profit. <b>%15- POWER:</b> Accumulation. System updates every 15 seconds.</i></p>
    </div>
    """, unsafe_allow_html=True)
